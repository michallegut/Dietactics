...
<div class="container">
    <h1 class="mt-4">Edytuj plan żywieniowy</h1>
    <%
    ...
    <div class="row my-4">
        <div class="col-md-6">
            <div class="card">
                <h5 class="card-header">Edytowany plan żywieniowy</h5>
                <div class="card-body">
                    <%
                    ...
                    %>
                    <form action="editMealPlan" method="post">
    ...
    <span class="input-group-text"
        ...
        <div class="col-md-6">
            <h5 class="mb-4">Wybierz posiłki</h5>
            <div class="accordion">
                <%
