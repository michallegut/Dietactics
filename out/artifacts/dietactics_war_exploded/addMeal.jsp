...
<div class="container">
    <h1 class="mt-4">Dodaj posiłek</h1>
    <%
    ...
    <div class="row my-4">
        <div class="col-md-6">
            <div class="card">
                <h5 class="card-header">Nowy posiłek</h5>
                <div class="card-body">
                    <%
                    ...
                    %>
                    <div class="alert alert-danger" role="alert">
                        Nazwa posiłku może mieć maksymalnie 50 znaków długości
                    </div>
                    <%
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <form method="post" action="includeProduct"
                                        ...
                                        <label for="productId<c:out value='<%=productEntity.getId()%>'/>"
